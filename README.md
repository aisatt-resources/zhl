...
*１．バックエンドフレームワーク: Spring Boot (バージョン 3.5.10)
*２．永続層フレームワーク: MyBatis (バージョン 3.0.5)
*３．テンプレートエンジン: Thymeleaf
*４．データベース: MySQL
*５．ビルドツール: Maven
*６．開発ツール: Lombok (Java Bean の記述簡素化)、Spring Boot DevTools (ホットデプロイ)
*７．テストフレームワーク: Spring Boot Starter Test、MyBatis Spring Boot Starter Test
*８．Java バージョン: 17
