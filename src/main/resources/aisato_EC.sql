...
-- サンプル商品（6件、画像URL追加）
INSERT INTO `products` ( `product_name`, `product_code`, `category_id`, `brand`, `author`, `price`, `stock_quantity`, `description`, `image_url`, `sales_status`, `weight`, `dimensions`, `color_options`, `size_options`, `create_Time`, `update_Time`) VALUES 
('ファイヤーバード トラックトップ', 'TSHIRT001', 6, 'Adidas', NULL, 13200.00, 10000, 'ゆったりとしたフィット感のトラックトップで、クラシックなスリーストライプススタイルを見せつけよう。\r\nアディダスの伝統を語る上で欠かせないものの1つが、このファイヤーバード トラックトップ（ジャージ）。スタンドカラーからリブ編みの裾まで、一目でわかるシルエット。\r\n\r\nアディカラー・スポーツ・シリーズの一部であり、大胆なエネルギーを感じられる一着。トリコット生地は、いつでも滑らかで快適な肌触り。また、ルーズフィットのデザインなので、ゆったりとした着心地でリラックスできる。\r\n\r\nジーンズやセットのトラックパンツとの相性も抜群で、さまざまな場面にマッチ。さらに、目を引くトレフォイルとスリーストライプスで、アディダススタイルを常にアピール。', '/images/tshirt.jpg', 1, NULL, NULL, '[\"ホワイト\", \"ブラック\", \"ブルー\"]', '[\"S\", \"M\", \"L\", \"XL\"]', '2026-02-13 12:34:53', '2026-02-19 09:23:30');
('iphone17pro Max', 'PHONE001', 8, '‎Apple', NULL, 229800.00, 50000, 'Apple iPhone 17 Pro Max (512 GB)：ProMotion を採用した6.9 インチディスプレイ、 A19 Pro チップ、iPhone 史上最長のバッテリー駆動時間、センターフレームフロント カメラを搭載したPro Fusion カメラシステム；ディープブルー', '/images/smartphone.jpg', 1, 204.00, '‎0.87 x 7.8 x 16.34 cm', '[\"ディープブルー\", \"コズミックオレンジ\", \"シルバー\"]', '[\"128GB\", \"256GB\", \"512GB\"]', '2026-02-13 12:34:53', '2026-02-19 09:45:13');
(' MacBook Pro 10', 'LAPTOP001', 9, '‎Apple', NULL, 238747.00, 1000, 'Apple 2025 MacBook Pro 10 コアCPU、10 コアGPU のM5 チップ搭載ノートパソコン：Apple Intelligence のために設計、14.2 インチLiquid Retina XDR ディスプレイ、16GB ユニファイドメモリ、512GBのSSD ストレージ - スペースブラック', '/images/laptop.jpg', 1, 1.55, '31.26 x 22.12 x 1.55cm', '[\"シルバー\", \"ブラック\"]', '[\"13インチ\", \"15インチ\"]', '2026-02-13 12:34:53', '2026-02-19 14:37:51');
('ウォックパン', 'KITCHEN001', 10, 'ニトリ', NULL, 4490.00, 1000, '●使いはじめのこびりつきにくさが長持ち\r\n●ベストなタイミングで調理スタートできるお知らせマーク\r\n●優れたチタンコーティングでこびりつきにくい\r\n●均一な熱伝導の底面\r\n●PFOA・鉛・カドミウム不使用', '/images/kitchen_set.jpg', 1, 0.79, '\r\n\r\n47.1×29.5×9.3cm', '[\"ブラック\"]', '[\"20\", \"24\", \"26\", \"28\"]', '2026-02-13 12:34:53', '2026-02-19 16:14:27');
('ビジネスリュック', 'BACKPACK001', 4, 'Hp hope', NULL, 5900.00, 10000, '[Hp hope] ビジネスリュック 防水 大容量 軽量 男女兼用 PC バッグ USB充電ポート付き ファッションリュック 耐衝撃 通勤 通学 旅行 サイクリングに最適 15.6インチ', '/images/backpack.jpg', 1, 0.80, '42×30×18cm', '[\"ブラック\", \"グリーン\", \"ブルー\"]', '[\"S\", \"M\", \"L\"]', '2026-02-13 12:34:53', '2026-02-19 16:14:28');
('死ぬまでに観に行きたい世界の超絶美術を1冊でめぐる旅', 'BOOK001', 5, NULL, '山上　やすお', 2200.00, 10000, '海外旅行添乗員/アート系ユーチューバー\r\n博物館学芸員資格保有\r\n兵庫県伊丹市出身。幼少の頃から絵を描くことが好きで、大学では美術部で美術を学び、イラストの制作も開始。2007年株式会社フォーラムジャパン入社。海外をメインとした旅行の添乗員として1年の半分以上は世界各地を飛び回り、中でも美術館などアート関連での添乗に高評価を得る。2016年より、アートの素晴らしさをわかりやすく伝えるための講座を全国各地で開催。その後、コロナ禍に突入したことから、アートに関するYouTube「こやぎ先生の美術チャンネル」を開設。有名な画家や美術展などを構成・解説、親しみやすいイラストが人気を呼び、チャンネル登録者が2万人を超える。2021年に開始したオンライン美術講座は総受講者数が5千人を超え、日本最大級の習いごと検索サービス「ストアカ」にて新人先生賞とストアカンオブザイヤーをダブルで受賞。2022年10月よりNHK文化センター講師、およびNHK学園オンライン講座を担当。毎日放送『三度の飯よりアレが好き!』にて地上波デビュー。話し方伝え方スペシャリスト資格保有。著書に『死ぬまでに観に行きたい世界の有名美術を1冊でめぐる旅』（ダイヤモンド社）『マンガで「なるほど名画」こやぎ先生が教える西洋絵画の7つのポイント』（SBクリエイティブ）がある。', '/images/book.jpg', 1, 0.51, '21 x 14.8 x 2 cm', '[\"なし\"]', '[\"通常\"]', '2026-02-13 12:34:53', '2026-02-19 16:27:19');
